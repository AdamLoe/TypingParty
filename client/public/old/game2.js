...
import TypingController from "../../src/containers/Game/TypingController";
...
class Game2 extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="Game">
        {isMenu ? <Menu /> : <RaceView {...this.state} />}
        {showTypingController && (
          <TypingController {...this.state} finishedRace={this.finishedRace} />
        )}
        {raceOver && (
          <RaceMenu gotoRace={this.gotoRace} gotoMenu={this.gotoMenu} />
        )}
      </div>
    );
  }
